...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOE, EN_DRV_Pin|outDown_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOD, USER_LD2_RED_Pin|USER_LD3_GREEN_Pin|DIR_Pin|STEP_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOG, outBack_Pin|outFront_Pin|outRight_Pin|outLeft_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : EN_DRV_Pin outDown_Pin LCD_DISP_EN_Pin */
  GPIO_InitStruct.Pin = EN_DRV_Pin|outDown_Pin|LCD_DISP_EN_Pin;
  ...
  /*Configure GPIO pin : outUp_Pin */
  GPIO_InitStruct.Pin = outUp_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(outUp_GPIO_Port, &GPIO_InitStruct);
  ...
  /*Configure GPIO pins : USER_LD2_RED_Pin USER_LD3_GREEN_Pin DIR_Pin STEP_Pin */
  GPIO_InitStruct.Pin = USER_LD2_RED_Pin|USER_LD3_GREEN_Pin|DIR_Pin|STEP_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOD, &GPIO_InitStruct);

  /*Configure GPIO pins : outBack_Pin outFront_Pin outRight_Pin outLeft_Pin */
  GPIO_InitStruct.Pin = outBack_Pin|outFront_Pin|outRight_Pin|outLeft_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
